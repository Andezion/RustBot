...
pub fn register(
    ...
    users: Users,
    counters: Counters,
    kb_help: crate::types::ReplyMarkup,
    kb_start: crate::types::ReplyMarkup,
    kb_keyboard: crate::types::ReplyMarkup,
) {
    use crate::types;
    ...
    disp.add_callback(|client: Client, cb: CallbackQuery| async move {
